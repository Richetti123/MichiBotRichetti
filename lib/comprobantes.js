...
export async function handleIncomingMedia(m, conn) {
    ...
    // --- LÓGICA PARA EXTRAER EL REMITENTE Y EL TIPO DE MENSAJE DE FORMA ROBUSTA ---
    ...
    // Usa extractedSenderJid y messageType para el resto de la lógica
    ...
    console.log('Tipo de mensaje (m.mtype original):', m.mtype); // Mantenemos para comparación, aunque usaremos 'messageType'
