...
export async function handleIncomingMedia(m, conn) {
    ...
    if (isMedia && isPaymentProof(captionText)) {
        console.log('Condiciones de comprobante CUMPLIDAS. Procediendo a reenviar...'); // Esta línea se mantiene, es informativa.
        ...
        try {
            ...
            console.error("Error al leer pagos.json en comprobantes.js:", e); // Se mantiene para errores
        }
        ...
        try {
            ...
            try {
                ...
                console.error('Error al descargar media a buffer:', downloadError); // Se mantiene para errores
            ...
            if (m.message.imageMessage) {
                ...
                console.error('Tipo de medio no soportado para reenvío directo vía buffer:', messageType); // Se mantiene para errores
            ...
            if (messageOptions.image || messageOptions.document) {
                ...
                console.log(`Comprobante de ${clientName} (${formattedSenderNumber}) reenviado al admin usando sendMessage directo (via buffer).`); // Esta línea se mantiene, es informativa.
            } else {
                console.error('No se pudo construir el mensaje de medios para reenvío directo.'); // Se mantiene para errores
            ...
            console.error('Error al reenviar comprobante al admin desde comprobantes.js:', e); // Se mantiene para errores
        ...
        console.log('Condiciones de comprobante NO CUMPLIDAS. El mensaje no se reenviará.'); // Esta línea se mantiene, es informativa.
    }
    return false;
}
